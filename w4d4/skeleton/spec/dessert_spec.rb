...
describe Dessert do
  let(:chef) { double("chef", name: "Eustace") }
  ...
  describe "#serve" do
    ...
    allow(chef).to receive(:titleize).and_return("Chef Eustace the Great Baker")
    expect(brownie.serve).to eq("Chef Eustace the Great Baker has made 50 brownies!")
    end
  end
